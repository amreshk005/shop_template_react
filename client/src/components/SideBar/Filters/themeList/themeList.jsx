...
export default function themeList() {
  const [theme] = useState(["Urban Backpacks", "Laptops", "Faux Leather", "Top Handle", "Superman", "Hand Carry"]);

  return (
    <>
      <div className={classes["sidebar__associate__content"]}>
        <div className={classes["sidebar__associate__content__titlesection"]}>
          <div className={classes["sidebar__associate__content__titlesection__title"]}>THEME</div>
